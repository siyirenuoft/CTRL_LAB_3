...
% Create title
title('Cart Variables as a Function of Time', ...
...
hline1 = plot(time, position, 'b', 'Linewidth',2);
...
if INCLUDE_2PCT_BANDS
    ...
    hline5 = plot(time_ival,  ref_ival+band_ival,  ...
                  time_ival,  ref_ival-band_ival,  ...
                  time_ival, -ref_ival+band_ival,  ...
                  time_ival, -ref_ival-band_ival, 'LineWidth', 1, 'color', [0, 0.5, 0]);
    legend([hline1,hline2,hline3,hline4,hline5(1)], 'Position', 'Velocity', ...
    'Reference Velocity', 'Filtered Velocity', '+/- 2%');
else

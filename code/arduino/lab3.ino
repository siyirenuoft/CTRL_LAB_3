...
//PARAMETERS
const double K = 0;     // insert your K value here
const double Ti = 0;    // insert your Ti value here
const double a = 0;     // insert your a value here
const double b = 0;     // insert your b value here
